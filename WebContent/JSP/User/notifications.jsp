          ...
          <div class="row">
            ...
            <% if(request.getParameter("v") == null || !request.getParameter("v").equals("all")){ %>
            	...
            	<% }else{ %>
            		...
            		<% 
            		query = "SELECT CONCAT(d.first_name, ' ', d.last_name) AS full_name, a.scheduled_date, n.seen FROM notifications AS n JOIN doctors AS d ON d.doctor_id = n.doctor_id JOIN appointments AS a ON a.appointment_id = n.appointment_id WHERE n.user_id = ? AND n.seen = false ORDER BY n.notification_id DESC";
            ...
            <% }else{%>
            	...
            	<% }else{ %>
            		...
            		<% 
            		query = "SELECT CONCAT(d.first_name, ' ', d.last_name) AS full_name, a.scheduled_date, n.seen FROM notifications AS n JOIN doctors AS d ON d.doctor_id = n.doctor_id JOIN appointments AS a ON a.appointment_id = n.appointment_id WHERE n.user_id = ? ORDER BY n.notification_id DESC";
            ...
            <%
           		...
           		query = "UPDATE notifications SET seen = true WHERE user_id = ? AND seen = false";
	           	ps = conn.prepareStatement(query);
	        	ps.setInt(1, Integer.parseInt(userId));

          ...
          <div class="container _container">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<% 
					...
					// Finding how many new notifications doctor has
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="list-group">
                ...
                <% 
					...
					query = "SELECT COUNT(*) FROM appointments WHERE doctor_id = ? AND status = 'completed'";
					ps = conn.prepareStatement(query);
					...
					query = "SELECT COUNT(*) FROM appointments WHERE doctor_id = ? AND status = 'canceled'";
					ps = conn.prepareStatement(query);
			...
			<% 
				...
				if(view == null || (!view.equals("pending") && !view.equals("completed") && !view.equals("canceled"))){
					...
					count_query = "SELECT COUNT(*) FROM appointments AS a WHERE a.doctor_id = ?";
					
					query = "SELECT CONCAT(u.first_name, ' ', u.last_name) AS full_name, a.appointment_id, a.booked_date, a.scheduled_date, a.status, a.review FROM appointments AS a JOIN users AS u ON u.user_id = a.user_id WHERE a.doctor_id = ? ORDER BY a.scheduled_date DESC";
					
				}else if(view.equals("pending")){
					
					count_query = "SELECT COUNT(*) FROM appointments AS a WHERE a.doctor_id = ? AND a.status = 'pending'";
					
					query =  "SELECT CONCAT(u.first_name, ' ', u.last_name) AS full_name, a.appointment_id, a.booked_date, a.scheduled_date, a.status, a.review FROM appointments AS a JOIN users AS u ON u.user_id = a.user_id WHERE a.doctor_id = ? AND a.status='pending' ORDER BY a.scheduled_date DESC";
					
				}else if(view.equals("completed")){
					
					count_query = "SELECT COUNT(*) FROM appointments AS a WHERE a.doctor_id = ? AND a.status = 'completed'";
					
					query = "SELECT CONCAT(u.first_name, ' ', u.last_name) AS full_name, a.appointment_id, a.booked_date, a.scheduled_date, a.status, a.review FROM appointments AS a JOIN users AS u ON u.user_id = a.user_id WHERE a.doctor_id = ? AND a.status='completed' ORDER BY a.scheduled_date DESC";
					
				}else if(view.equals("canceled")){
					
					count_query = "SELECT COUNT(*) FROM appointments AS a WHERE a.doctor_id = ? AND a.status = 'canceled'";
					
					query = "SELECT CONCAT(u.first_name, ' ', u.last_name) AS full_name, a.appointment_id, a.booked_date, a.scheduled_date, a.status, a.review FROM appointments AS a JOIN users AS u ON u.user_id = a.user_id WHERE a.doctor_id = ? AND a.status='canceled' ORDER BY a.scheduled_date DESC";
			...
			<% if(status.equals("pending")){ %>
				...
				<div class="panel panel-info">
	                ...
	                <div class="panel-body">
	                  <strong>Patient's Name: </strong><a href=""><%= usersName %></a><br/>
